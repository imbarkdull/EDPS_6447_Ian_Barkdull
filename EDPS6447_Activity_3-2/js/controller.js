...
function incrementQuestion() {
	...
	if (array_questions[counter].type == "true_false") {
		text_input3.classList.add("d-none");
		input_3.classList.add("d-none");
	} else {
		text_input3.classList.remove("d-none");
		input_3.classList.remove("d-none");
	}
	if (array_questions[counter].type == "true_false") {
		text_input4.classList.add("d-none");
		input_4.classList.add("d-none");
	} else {
		text_input4.classList.remove("d-none");
		input_4.classList.remove("d-none");
	}
